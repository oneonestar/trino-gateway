        ...
        extends ProxyHandler
{
            ...
            ProxyHandlerStats proxyHandlerStats)
    {
        ...
        this.routingDestinationHandler = routingDestinationHandler;
    ...
    public void preConnectionHook(HttpServletRequest request, Request proxyRequest)
    {
        ...
        if (routingDestinationHandler.isPathWhiteListed(request.getRequestURI())) {
    ...
    public String rewriteTarget(HttpServletRequest request)
    {
        ...
        return routingDestinationHandler.getRoutingDestination(request);
    }
