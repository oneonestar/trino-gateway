...
import io.trino.gateway.ha.handler.RoutingDestinationHandler;
        ...
        implements ContainerRequestFilter
{
    ...
    private final RoutingDestinationHandler routingDestinationHandler;

    @Inject
    public RouterPreMatchContainerRequestFilter(RoutingDestinationHandler routingDestinationHandler)
    {
        this.routingDestinationHandler = requireNonNull(routingDestinationHandler);
    }
    ...
    public void filter(ContainerRequestContext request)
            throws IOException
    {
        if (routingDestinationHandler.isPathWhiteListed(request.getUriInfo().getRequestUri().getPath())) {
